...
API_ID = int(environ.get('API_ID', '18799477'))
API_HASH = environ.get('API_HASH','305cfa73e8b06daa97573809532034e5')
BOT_TOKEN = environ.get('BOT_TOKEN','6839445804:AAHM0HhNLEJAezhUqGygolqUIbATTyLjDKQ')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5781922761').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://tolrec4:m4n1D28syvv6Yoo4@cluster0.6qokedq.mongodb.net/?retryWrites=true&w=majority")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001956948857))
